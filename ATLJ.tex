...
\end{proof}
\nn{Error in the above formula for resolvent, [m] out front should be in Numerator not denominator, because we've taken (Blah)^-1! Thats what we get for pulling things out front}
