...
%    \draw (1.3,.3) arc (180:0:.2cm) -- (1.7,-2) .. controls ++(270:1.3cm) and ++(270:1.3cm) .. (-1.7,-2) -- (-1.7,0) .. controls ++(90:.6cm) and ++(270:.6cm) .. (-1.3,.9);
    \draw (0,0) -- (0,.8);
    \draw (-.8,-1) -- (-.8,0);
%
    \roundNbox{unshaded}{(0,0)}{.3}{2}{2}{$\jw{m}$}
%    \roundNbox{unshaded}{(0,1.2)}{.3}{1.2}{1.2}{$\jw{m}$}
...
%
    ...
    \draw (a) -- ($ (a) + (0,.8)$);
    \draw (b) -- ($ (b) + (0,.75)$);
    \draw (.7,-1) arc (180:0:.2cm) -- (1.1,-2) .. controls ++(270:.9cm) and ++(270:.9cm) .. (-1.1,-2) -- (-1.1,0);
    \draw (1.3,0) -- (1.3,-2) .. controls ++(270:1.1cm) and ++(270:1.1cm) .. (-1.3,-2) -- (-1.3,0);
    \draw (1.3,.3) arc (180:0:.2cm) -- (1.7,-2) .. controls ++(270:1.3cm) and ++(270:1.3cm) .. (-1.7,-2) -- (-1.7,0) .. controls ++(90:.6cm) and ++(270:.6cm) .. (-1.3,.9);
    \draw (0,0) -- (0,2);
    \draw (-.8,-1) -- (-.8,0);
%
    \roundNbox{unshaded}{(0,0)}{.3}{1.2}{1.2}{$\jw{m}$}
    \roundNbox{unshaded}{(0,1.2)}{.3}{1.2}{1.2}{$\jw{m}$}
    \ncircle{unshaded}{(-.5,-2)}{.3}{270}{$S_+$}
    \ncircle{unshaded}{(.5,-2)}{.3}{270}{$S_-$}
%
    \draw[decorate, decoration={complete sines, segment length=.2cm, amplitude=.1cm}] (-.9,-1.2) -- (.9,-1.2);
    \draw[decorate, decoration={complete sines, segment length=.2cm, amplitude=.1cm}] (-.9,-1) -- (.9,-1);
%
    \node at (-.1,-.6) {\scriptsize{$m-2i-j$}}; 
    \node at (.5,.6) {\scriptsize{$m-1$}}; 
    \node at (.2,1.8) {\scriptsize{$m$}}; 
    \node at (1,-1.5) {\scriptsize{$j$}}; 
    \node at (1.4,-1.5) {\scriptsize{$i$}}; 
    \node at (1.8,-.6) {\scriptsize{$1$}}; 
    \node at (0,-1.8) {\scriptsize{$k_i$}}; 
\end{tikzpicture}
$$
...
\end{align*}
\end{lem}
\nn{Note we are using the signed convention, so $[2] = -q -q^{-1}$}
